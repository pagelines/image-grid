...
class ImageGrid extends PageLinesSection {
	...
	function section_head( $clone_id) {
		...
		<script type="text/javascript">
			jQuery(document).ready(function($){
				var $ig_modal = $('#ig_modal').modal({show: false});
		...
		$option_array = array(
			'ig_configs' => array(
				...
				'selectvalues' => array(
					...
					'ig_orderby' => array( 'inputlabel' => 'Order According To (Default: Menu Order)', 'type' => 'select', 'selectvalues' => array(
	...
	function ig_draw_images( $ig_images ) {
		...
		<div class="pl-ig-container">
			<div id="ig-images-container" class="ig-images-container">
				<?php
				...
				?>
						...
						<div class="ig-image-container <?php echo $ig_cols; ?>">
							<figure class="ig-cap-bot">
								<a href="#" class="ig-image" data-slide-index="<?php echo $ig_image_number; ?>">
				...
				?>
				<div id="ig_modal" class="modal fade hide">
